        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages2" aria-expanded="true" aria-controls="collapsePages2">
                    ...
                    <span style="font-size: 90%;">${mensaje.get("Not")}</span>
                </a>
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">${mensaje.get("op")}</h6>
                        <a class="collapse-item" href="./estuBuscarNotas">${mensaje.get("bus")}</a>
                    </div>
                </div>
            </li>
             <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
                    ...
                    <span style="font-size: 90%;">${mensaje.get("matr")}</span>
                </a>
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">${mensaje.get("op")}</h6>
                        <a class="collapse-item" href="./estuRegistrarMatricula">${mensaje.get("regir")}</a>
                        <a class="collapse-item" href="./estuBuscarMatricula">${mensaje.get("bus")}</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages4" aria-expanded="true" aria-controls="collapsePages4">
                    ...
                    <span style="font-size: 90%;">${mensaje.get("gru")}</span>
                </a>
                <div id="collapsePages4" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">${mensaje.get("op")}</h6>
                        <a class="collapse-item" href="./estuBuscarGrupo">${mensaje.get("bus")}</a>                        
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages3" aria-expanded="true" aria-controls="collapsePages">
                    ...
                    <span style="font-size: 90%;">${mensaje.get("mat")}</span>
                </a>
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">${mensaje.get("op")}</h6>
                        <a class="collapse-item" href="./estuBuscarMateria">${mensaje.get("bus")}</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapsePages5" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="./estuCambiarContrasena">${mensaje.get("camcon")}</a>
                        <a class="collapse-item" href="./estuCambiarNombre">${mensaje.get("camnom")}</a>
                    </div>
                </div>
            </li>
        </ul>
